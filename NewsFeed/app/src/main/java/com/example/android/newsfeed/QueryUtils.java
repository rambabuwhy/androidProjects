...
/**
 * Helper methods related to requesting and receiving newsFeeds data from USGS.
 */
public final class QueryUtils {
    ...
    private static List<NewsFeed> extractFeatureFromJson(String newsFeedJSON) {
        ...
        try {
            ...
            JSONObject currentResponse = baseJsonResponse.getJSONObject("response");
            JSONArray newsFeedArray = currentResponse.getJSONArray("results");
            ...
            for (int i = 0; i < newsFeedArray.length(); i++) {
                ...
                // for that newsFeed.
                String section_name = currentnewsFeed.getString("sectionName");

                // Extract the value for the key called "mag"
                String web_title = currentnewsFeed.getString("webTitle");
                ...
                NewsFeed news_Feeds = new NewsFeed(web_title, section_name, url);

                // Add the new {@link newsFeeds} to the list of newsFeeds.
                newsFeeds.add(news_Feeds);
            }
